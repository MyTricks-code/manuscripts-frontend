          ...
          <div className="md:pb-12 relative overflow-hidden p-1 mb-2 rounded" key={item.attributes.slug}>
            <div className="rounded-lg lg:p-2 lg:pb-6 " key={item.attributes.slug}>
              ...
              <div className="flex">
                ...
                <Moment format="MMM Do, YYYY" className='ml-2 dark:text-neutral-100'>
                  <h3 className="tracking-widest text-indigo-500 text-xs ml-2 dark:text-white font-medium title-font">{item.attributes.date}</h3>
                </Moment>
              </div>
